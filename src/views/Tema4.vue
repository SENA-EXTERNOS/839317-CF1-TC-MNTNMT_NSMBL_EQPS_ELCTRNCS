...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Son documentos que brindan información técnica relevante sobre los equipos; generalmente, son proporcionados por los fabricantes y, en algunos casos, son construidos por las organizaciones, basándose en sus necesidades.

    .row.align-items-center.justify-content-center
      .col-md-8.order-sm-last.order-sm-first
        TabsA.color-acento-botones
          .tarjeta.color-acento-botones.p-4(titulo="Manual de usuario")
          ...
          .tarjeta.color-acento-botones.p-4(titulo="Manual de fabricante")
      ...
      .col-md-4.order-sm-first.order-md-last(data-aos="flip-left")
        figure
