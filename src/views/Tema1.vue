...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bloque-texto-g.bgr-cuadro-tema1.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/t1/f1.png')})`}",data-aos="fade-right"
      )
      .bloque-texto-g__texto.p-4
        p.mb-0 En la actualidad, la información se ha convertido en uno de los activos más valiosos para las organizaciones; por esta razón, se le debe dar un manejo riguroso, porque es un insumo vital para la gestión del conocimiento, análisis y toma de decisiones, con resultados tangibles en lo económico y en la producción. 

    .row.mt-5
      h3 Documentos asociados

    p El sistema de información, está compuesto por diferentes documentos asociados, los cuales se utilizan para llevar, de una forma clara y ordenada, la información y las intervenciones realizadas en los equipos.
      ...
      .col-md-7
        AcordionA(tipo="a" clase-tarjeta="tarjeta fcp35")
          ...
          div(titulo="Sistema de codificación")
            p.mb-0 Esta es una actividad que debe realizar cada organización, dado que todas se identifican con diferentes procesos y zonas que son propias, para ello, pueden hacer uso de diferentes criterios de identificación tales como: ubicación, costos, producción, criticidad, histórico de fallos e intervenciones realizadas, entre otras; lo anterior, puede hacerse de una forma específica o no específica, empleando diferentes técnicas y siglas que pueden contener: nombres, secciones, letras, números o la combinación de ellas.

    .row.mt-5
      h3 Documentación e información 

    .bloque-texto-a.color-secundario.gr1.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-8
          .bloque-texto-a__texto.p-4
            p.mb-0 Todos los equipos de las organizaciones se constituyen en un bien tangible, porque representan parte de su economía y se deben preservar de la mejor manera posible; una buena forma de hacerlo es recopilando la mayor cantidad de información que se pueda de los mismos, y con el máximo de detalle posible. Dentro de estos documentos, se encuentran los que son suministrados por el fabricante y, otros, conformados por la organización.
        .col-lg-4.mb-4.mb-lg-0(data-aos="fade-left")

    .row.mt-5
      h3 Hoja de vida de equipos
