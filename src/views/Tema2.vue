  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-around.mb-5
      .col-md-5(data-aos="zoom-in")
        img(src="@/assets/curso/temas/t2/f2.png", alt="Ambiente de aprendizaje")
      .col-md-5(data-aos="zoom-in")
    ...
    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/_Rcve-n36U0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    TabsC.color-acento-botones.mb-5
      .py-3.py-md-4(titulo="Manejo de proveedores")
        .row.justify-content-around.align-items-center
          .col-md-6(data-aos="fade-right")
            figure
              img(src='@/assets/curso/temas/t2/f17.png', alt='Texto que describa la imagen')
          .col-md-6.mb-4.mb-md-0
